package com.example.mati.restaurante2;
...
/**
 * Created by mati on 11/12/14.
 */
public class DBHelper extends SQLiteOpenHelper {

    //Ruta por defecto de las bases de datos en el sistema Android
    private static String DB_PATH = "/data/data/com.example.mati.restaurante2/databases/";

    private static String DB_NAME = "Restaurante2.db";
